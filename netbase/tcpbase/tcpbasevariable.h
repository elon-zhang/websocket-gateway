#ifndef TCPBASEVARIABLE_H_
#define TCPBASEVARIABLE_H_
...
const int RECV_BUFF_SIZE = (200*1024);  //内部组件通信的200K缓存
//int RECV_BUFF_SIZE = (200 * 1024);  //内部组件通信的200K缓存
...
const uint32_t MAX_ONLINE_CONNECT_COUNT = 65535;
