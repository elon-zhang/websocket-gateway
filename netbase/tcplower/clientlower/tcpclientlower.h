#ifndef TCPCLIENTLOWER_H_
#define TCPCLIENTLOWER_H_
...
class TcpClientLower:public ITcpClientFunction
{
public:
	friend class TcpClientCreatorLower;
	TcpClientLower(
...
public:
	///获取应用层的回调接口
	ITcpClientModule* GetCallback(){return m_lpCallback;}
	///获取连接次数
...
protected:
	///主动连接对象的连接
	ActiveConnectLower		m_Connect;
	///应用层回调接口
	ITcpClientModule* m_lpCallback;
	///发送线程索引
